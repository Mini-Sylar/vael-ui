<template>
  <header class="demo-header">
    <h1>vapor-lib — real components, real Vapor</h1>
    <ThemeToggle />
  </header>
...
// Broad smoke pass: mounts every one of the 38 public components with
// minimal, sane props, through the BUILT dist bundle, no interop plugin.
// Not exhaustive per-component behavior coverage — this catches gross
// breakage (crashes, mount failures) across the whole batch cheaply; the
// individual Button/DataTable tests carry the deeper interaction coverage.
import {
  Accordion,
  Avatar,
  Badge,

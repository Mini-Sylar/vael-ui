<template>
  <section class="demo">
    ...
    <p class="note">
      ...
      <code>Menu</code> doesn't have — it renders <code>aria-current="page"</code> on the current
      row. An <code>.items</code> entry (see "Team" below) becomes a flattened, always-expanded
      group label rather than a hover submenu — a real collapsible group composes this with the

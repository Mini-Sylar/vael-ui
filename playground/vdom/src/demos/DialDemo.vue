<template>
  <section class="demo">
    ...
    <h3>Bounded vs. unbounded, side by side</h3>
    <p class="note">
    ...
    <h3>Disabled</h3>
    <div class="row dial-row">
      <Dial v-model="disabledValue" disabled :min="0" :max="100" />
    </div>
    ...
    <p class="note">A dial with a <code>name</code> renders a hidden input automatically.</p>
    <form class="row dial-row" style="align-items: center" @submit.prevent="onSubmit">

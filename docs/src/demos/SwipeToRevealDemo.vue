<template>
  <section class="demo">
    ...
    <p class="note">
      ...
      the DOM and Tab-reachable even while closed, try Tab-ing through the list below with the mouse
      untouched, or use the <code>…</code> button on the last row, which calls
      <code>reveal()</code>

<template>
  <section class="demo">
    ...
    <p class="note">
      ...
      the host serves every target with one floating element and two document-level listeners, so
    ...
    <h3>Toolbar, <code>v-tooltip</code> directive with a shared warm group</h3>
    <div class="row">
      <Button
